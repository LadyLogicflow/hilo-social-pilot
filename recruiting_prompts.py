...
SYSTEM = (
    ...
    "Hook. Variiere die FORM von Post zu Post - mal ein staccato-Dreiklang, mal ein einzelner "
    "schlagkraeftiger Satz, mal eine kurze Frage. Niemals zweimal dieselbe Zeile (alle Beispiele hier sind "
    "NUR Stilreferenz, NIEMALS woertlich uebernehmen). WENN Dreiklang: bevorzugt 2x 'Ihr/Ihre ...' und als "
    "DRITTEN Teil 'Unser ...' - das landet den Gemeinsam-/Zugehoerigkeits-Gedanken (z.B. 'Ihre Zeit. Ihr "
    "Business. Unser Verein.' / '... Unser Rueckhalt.' / '... Unser Team.'). Dann JEDES MAL sowohl die "
    "beiden 'Ihr/Ihre'-Woerter ALS AUCH das 'Unser ...'-Wort wechseln - nicht dauerhaft 'Unser Rueckhalt' "
    "und nicht immer 'Unser Verein'. Hoechstens 60 Zeichen. "
    "KEINE Vorzugs- oder "

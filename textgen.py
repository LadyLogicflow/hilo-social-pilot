...
SYSTEM = (
    ...
    "2) CAPTION (Begleittext unter dem Bild): Beginne mit einem starken HOOK in den ersten ein bis zwei "
    "Zeilen, der sofort einen Nutzen, eine Frage oder eine Ueberraschung liefert - NICHT 'Die "
    "Steuererklaerung ist wichtig', sondern zum Beispiel 'Viele verschenken jedes Jahr hunderte Euro - "
    "einfach weil sie eine Sache nicht wissen.' Erklaere danach das Thema knapp und nutzenorientiert, "
    "sprich konkrete Alltagssituationen der Zielgruppe an, ende mit einem klaren Handlungsaufruf und "
    "weise dezent auf die HILO-Mitgliedschaft bzw. persoenliche Beratung hin. In der CAPTION duerfen "
    "SPARSAM Emojis vorkommen (ein bis drei, passend gesetzt - etwa im Hook oder vor dem Handlungsaufruf), "

...
def _build_prompt(thema, kanal=None):
    ...
    return (
        ...
        '"szene_motiv": "Kreatives, visuelles Motiv zum Thema - DENK UEBER KLISCHEES HINAUS. Kann sein: (1) Menschen in authentischer Alltagssituation, (2) symbolische Gegenstaende/Objekte (Aktenordner, Kalender, Muenzen, Sparschwein, Taschenrechner), (3) atmosphaerische Szenen OHNE Personen. Beschreibe konkret WAS im Bild zu sehen ist, mit Jahreszeit/Licht/Stimmung. Ein Satz, praezise.", '
        '"bild_motiv": "Alternatives visuelles Motiv (Menschen ODER Objekte), ein Satz", '

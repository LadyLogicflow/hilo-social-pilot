...
def _build_prompt(thema, kanal=None):
    ...
    return (
        ...
        '"szene_motiv": "Motiv fuer ein hochwertiges Foto. Erlaubt sind BEIDE Varianten: (a) inszenierte Still-Life-Szene mit symbolischen Objekten (Aktenordner, Kalender, Muenzen, Sparschwein, Taschenrechner, Dokumente, Stifte, Stempel) ODER (b) eine echte, AKTIVE Szene MIT Personen, die sichtbar ETWAS TUN (eine Handlung, eine Emotion, ein Vorher-Nachher-Moment). VERBOTEN bei Personen: typische Steuerberater-/Beratungsszene, jemand der ueber Unterlagen oder am Schreibtisch sitzt, gestellte Stockfoto-Posen, Personen die nur posieren oder in die Kamera laecheln. Beschreibe AUSFUEHRLICH (2-3 Saetze): (1) Objekte bzw. Handlung/Personen, (2) Wie arrangiert/inszeniert, (3) Licht/Atmosphaere/Farben - Standard: helle, luftige Ausleuchtung, warmes Tageslicht. Sei KONKRET und DETAILLIERT.", '
        '"bild_motiv": "Alternatives Motiv - kurz beschreiben (Objekt-Stillleben ODER aktive Szene, bei Personen keine Beratungs-/Schreibtischszene).", '
